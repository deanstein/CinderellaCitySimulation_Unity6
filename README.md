...
# A Retail History Simulation
The [Cinderella City Simulation](https://www.cinderellacityproject.com/simulation) is a digital reconstruction of [Cinderella City Mall](https://www.cinderellacityproject.com/history) as an interactive virtual history exhibit.

The real Cinderella City existed in Englewood, Colorado from 1968 to 1997. 

The project aims to accurately rebuild the mall in two distinct time periods, reconstructed through an architect's lens using real blueprints, directories, and photos.

Learn more about the [Cinderella City Project](https://www.cinderellacityproject.com).
...
Modeled in [Autodesk FormIt](https://formit.autodesk.com/), and brought to life in [Unity](https://unity.com/), the simulation illustrates distinct time periods of Cinderella City's three-decade life, including the colorful 1968-1978 era, and the staid 1987-1997 era. 

Eventually, the simulation will also offer an "Alternate Future" interactive exhibit showing how the shopping center could have been adaptively reused in 1998 in lieu of demolition.
